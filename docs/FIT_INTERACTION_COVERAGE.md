...
| All declared interactions | **328 / 600** |
| **Locked-anchor interactions** | **129 / 179** |
| Locked anchors complete **and reachable** | **10** of 29 |
| Anchors whose route has **no way in** | **6** — FIT-071, FIT-072, FIT-019, FIT-074, FIT-006, FIT-073 |

## Every anchor, by remaining gap

| Anchor | Locked | Covered | Gap | Name | Route |
|---|---|---|---|---|---|
| **FIT-095** | — | 2/15 | 13 | Grocery list — built | `/grocery-list` |
...
| **FIT-105** | — | 8/15 | 7 | AI Coach — how it speaks, what it knows | `/ai-coach` |
...
| **FIT-071** | — | 1/6 | 5 | Pods hub — **UNREACHABLE** | `/pods` |
| **FIT-031** | 🔒 | 1/5 | 4 | Plans | `/upgrade` |
| **FIT-039** | — | 2/6 | 4 | Experience | `/intake` |
| **FIT-103** | — | 1/5 | 4 | AI Coach — today | `/ai-coach` |
| **FIT-044** | — | 5/9 | 4 | Lifestyle | `/intake` |
| **FIT-102** | — | 3/7 | 4 | AI Coach — first open | `/ai-coach` |
| **FIT-104** | — | 1/5 | 4 | AI Coach — the week | `/ai-coach` |
...
| **FIT-072** | — | 1/5 | 4 | Pod detail — **UNREACHABLE** | `/pods` |
| **FIT-110** | — | 1/4 | 3 | AI Coach — coming back | `/ai-coach` |
...
| **FIT-090** | — | 3/4 | 1 | AI nutrition — a turn that failed | `/ai-nutrition` |
...
| **FIT-074** | — | 1/2 | 1 | Pods — empty + loading — **UNREACHABLE** | `/pods` |
...
| **FIT-089** | — | 6/7 | 1 | AI nutrition — conversation | `/ai-nutrition` |
...
| **FIT-092** ✅ | — | 4/4 | 0 | Meal plan — built | `/meal-plan` |
| **FIT-093** ✅ | — | 2/2 | 0 | Meal plan — it didn’t build | `/meal-plan` |
| **FIT-094** ✅ | — | 3/3 | 0 | Grocery list — the two blocked states | `/grocery-list` |
