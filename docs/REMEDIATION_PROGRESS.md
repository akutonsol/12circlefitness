...
**Last updated:** 2026-08-27 · **Wave 1 spine complete · Wave 2 P0 remediation live-verified · CI run #32 (`ae5be13`) fully green — AI suite 49/49, 17/17 characterizations still reproduce, live SQL evidence executed · 28 findings `VERIFIED_CLOSED` (registry §7.8, §7.9, §7.10, §7.12)**
...
| `READY_TO_REMEDIATE` | 179 | −1: `ENV-3` → `REMEDIATED` (W1-T3, 2026-08-25) · **−1 at `388b5c1`: `SEC-R1` → `VERIFIED_CLOSED` (registry §7.10)**. `SEC-R2`/`SEC-R3` stay here understated: four of five evidence states present, `VERIFIED END-TO-END` outstanding, and §2 has no status for that position — owner ruling requested (§7.10) |
...
| `RETEST_REQUIRED` | 0 | |
| **`VERIFIED_CLOSED`** | **27** | 23 at `6d42b10` (registry §7.8) **+3 at `2a8d0b6`** (registry §7.9): **ENV-3, SEC-11, OBS-4** · **+1 at `388b5c1`** (registry §7.10): **SEC-R1 / F-J-01** |
| `DEFERRED` | 0 | |
| `RELEASE_BLOCKER` | 56 | a gate attachment, not a severity — counted inside the rows above |
| **Canonical total** | **319** | 310 from 428 raw records + 9 Wave 1 batch discoveries (W1B-N1…N9). Status sum: 37+48+24+179+4+27 = 319 ✓ |
...
**Answered: 4** — **`PD-A05` (2026-08-27, option (a): decision-trace reads are scoped to subject +
...
**Open: 72** — A:25 *(−1: `PD-A05` answered 2026-08-27)* · B:27 · C:5 · D:8 · E:8 · F:4 · G:4 *(some groups overlap where a
